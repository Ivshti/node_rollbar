...
function _buildTraceData(chain) {
  return function(ex, cb) {
    parser.parseException(ex, function (err, errData) {
      ...
      chain.push({
        frames: SETTINGS.transformFrame ? errData.frames.map(SETTINGS.transformFrame) : errData.frames,
        exception: {
          class: errData['class'],
...
exports.handleError = function (err, req, callback) {
  ...
  if (err instanceof Error) {
    return exports.handleErrorWithPayloadData(err, SETTINGS.defaultPayload || {}, req, callback);
  }
